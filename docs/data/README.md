...
- AOI hierarchy and grid bridge audit: run
  ...
  to regenerate `outputs/housing_fusion/community_aoi_bridge_report.md`.
  <!-- Previous direct link to the rebuildable output:
  ../../outputs/housing_fusion/community_aoi_bridge_report.md -->
