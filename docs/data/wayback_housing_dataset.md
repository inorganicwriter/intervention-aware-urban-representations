...
The authoritative audit is regenerated by
[`../../scripts/analysis/audit_housing_acquisition.py`](../../scripts/analysis/audit_housing_acquisition.py)
at `outputs/housing_acquisition/housing_acquisition_report.md`.
<!-- Previous direct link to the rebuildable output:
../../outputs/housing_acquisition/housing_acquisition_report.md -->
