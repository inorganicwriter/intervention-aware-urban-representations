...
- [`DDR-003_complete_published_estimators.md`](DDR-003_complete_published_estimators.md): independent implementations of PanelMatch, Abadie and Imbens matching, and Xu GSC.
...
- `superseded`: replaced in the active tree; Git history preserves the earlier version.
