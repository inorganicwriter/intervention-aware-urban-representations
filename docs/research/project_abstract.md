...
Current urban representation learning captures spatial appearance—what a place looks like—but cannot distinguish places that respond similarly to policy from places that merely look similar. This limits cross-city generalization: two neighborhoods with identical visual features may follow divergent trajectories under the same transit intervention, while visually dissimilar areas may converge.
